...
svm_precission = MLJ.precision(ordered_svm_pred, ordered_test_y)
...
# ╔═╡ 6b22780b-d9a7-4465-a172-16a7287f7ecc
md"### Principal Component Analysis"

# ╔═╡ aa46148b-e612-401e-bcae-d4cdd86610e2
pca = fit(PCA, train_x; maxoutdim=2)

# ╔═╡ 7aee9936-fc14-49de-83dc-01c1acbe3607
pca_train_components = MultivariateStats.predict(pca, train_x)

# ╔═╡ 4bec9aa4-905e-4c7b-8e99-97c782173a9d
pca_test_components = MultivariateStats.predict(pca, test_x)

# ╔═╡ 2da633e9-5524-4f7f-822b-0d1ed9a87d81
begin
	pca_plot = scatter(pca_test_components[1, :], xlabel="PC1")
	scatter!(pca_test_components[2, :], ylabel="PC2")
	plot(pca_plot, legend=false)
end
...
idxs, dists = knn(kdtree, test_x, 2, true)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "67bc309765b791a14b72af0d467b3e57ab05c05c"
